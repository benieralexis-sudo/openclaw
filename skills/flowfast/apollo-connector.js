...
class ApolloConnector {
  ...
  // NOTE: intent_topic_ids, intent_strength, person_changed_job_within_last_n_days
  // ont ete TESTES le 9 mars 2026 et sont IGNORES par l'API Apollo (meme total_entries).
  // Les filtres qui FONCTIONNENT : organization_latest_funding_stage_cd, revenue_range,
  // q_organization_keyword_tags, organization_num_employees_ranges.
  // L'Intent Monitor utilise ces filtres verifies directement via makeRequest().
