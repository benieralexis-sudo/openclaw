...
class ProspectResearcher {
  ...
  // Deprecated methods removed (v9.0): _fetchLinkedInData, _parseBraveLinkedInResults,
  // _parseBingLinkedInResults, _parseDDGLinkedInResults, _extractApolloOrgData, _fetchDropcontactData
  // All replaced by Clay enrichment pipeline.
