...
export default function RgpdPage() {
  return (
    <div className="max-w-3xl mx-auto px-6 lg:px-8 py-20">
      <h1 className="font-display text-3xl md:text-4xl font-semibold tracking-tight text-ink-900 mb-2">Politique RGPD</h1>
      ...
      <div className="max-w-none space-y-5 text-[15px] text-ink-700 leading-[1.7]">
        <h2 className="font-display text-xl md:text-2xl font-semibold tracking-tight mt-10 text-ink-900">1. Responsable de traitement</h2>
        <p>iFIND, [Raison sociale à compléter], dont le siège social est situé à [Adresse à compléter].</p>

        <h2 className="font-display text-xl md:text-2xl font-semibold tracking-tight mt-10 text-ink-900">2. Données collectées</h2>
        <p>
        ...
        <h2 className="font-display text-xl md:text-2xl font-semibold tracking-tight mt-10 text-ink-900">3. Base légale</h2>
        <p>
        ...
        <h2 className="font-display text-xl md:text-2xl font-semibold tracking-tight mt-10 text-ink-900">4. Durée de conservation</h2>
        <p>
        ...
        <h2 className="font-display text-xl md:text-2xl font-semibold tracking-tight mt-10 text-ink-900">5. Vos droits</h2>
        ...
        <h2 className="font-display text-xl md:text-2xl font-semibold tracking-tight mt-10 text-ink-900">6. Sous-traitants</h2>
        <p>
        ...
        <h2 className="font-display text-xl md:text-2xl font-semibold tracking-tight mt-10 text-ink-900">7. Sécurité</h2>
        <p>
        ...
        <h2 className="font-display text-xl md:text-2xl font-semibold tracking-tight mt-10 text-ink-900">8. Réclamation CNIL</h2>
        <p>
