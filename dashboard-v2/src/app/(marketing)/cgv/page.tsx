...
export default function CgvPage() {
  return (
    <div className="max-w-3xl mx-auto px-6 lg:px-8 py-20">
      <h1 className="font-display text-4xl font-bold text-ink-900 mb-2">Conditions Générales de Vente</h1>
      ...
      <div className="prose prose-ink max-w-none space-y-6 text-ink-700">
        <h2 className="font-display text-2xl font-bold text-ink-900">1. Objet</h2>
        <p>
        ...
        <h2 className="font-display text-2xl font-bold text-ink-900">2. Description de l&apos;offre</h2>
        <p>
        ...
        <h2 className="font-display text-2xl font-bold text-ink-900">3. Tarifs et facturation</h2>
        <p>
        ...
        <h2 className="font-display text-2xl font-bold text-ink-900">4. Garantie Pépite</h2>
        <p>
        ...
        <h2 className="font-display text-2xl font-bold text-ink-900">5. Engagement et résiliation</h2>
        <p>
        ...
        <h2 className="font-display text-2xl font-bold text-ink-900">6. Données et RGPD</h2>
        <p>
        ...
        <h2 className="font-display text-2xl font-bold text-ink-900">7. Responsabilité</h2>
        <p>
        ...
        <h2 className="font-display text-2xl font-bold text-ink-900">8. Loi applicable et juridiction</h2>
        <p>
