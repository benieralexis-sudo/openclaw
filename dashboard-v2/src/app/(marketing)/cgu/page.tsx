...
export default function CguPage() {
  return (
    <div className="max-w-3xl mx-auto px-6 lg:px-8 py-20">
      <h1 className="font-display text-4xl font-bold text-ink-900 mb-2">Conditions Générales d&apos;Utilisation</h1>
      ...
      <div className="prose prose-ink max-w-none space-y-6 text-ink-700">
        <h2 className="font-display text-2xl font-bold text-ink-900">1. Acceptation</h2>
        <p>L&apos;utilisation de la plateforme iFIND implique l&apos;acceptation pleine et entière des présentes CGU.</p>

        <h2 className="font-display text-2xl font-bold text-ink-900">2. Accès et compte utilisateur</h2>
        <p>
        ...
        <h2 className="font-display text-2xl font-bold text-ink-900">3. Utilisation conforme</h2>
        <p>
        ...
        <h2 className="font-display text-2xl font-bold text-ink-900">4. Propriété intellectuelle</h2>
        <p>
        ...
        <h2 className="font-display text-2xl font-bold text-ink-900">5. Disponibilité du service</h2>
        <p>
        ...
        <h2 className="font-display text-2xl font-bold text-ink-900">6. Suspension / Résiliation</h2>
        <p>
