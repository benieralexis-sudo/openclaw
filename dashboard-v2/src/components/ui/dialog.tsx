...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-md p-1.5 text-ink-500 opacity-70 transition-all hover:bg-ink-100 hover:text-ink-900 hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-brand-500 disabled:pointer-events-none">
        <X className="h-4 w-4" />
